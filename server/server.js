...
const { teamInfo, getTeams, getActivePlayers, tradePageSearch, tradePageTradingCard, playerName, updatePlayerTeam, teamGames, comparison, updateResult, gameResult, comparison1 } = require('./routes');
